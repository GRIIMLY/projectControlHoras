...
public class ControlRegistro implements Serializable {
	...
	@Id
	@Column(name="tblcontrol_diario_id")
	private int tblcontrolDiarioId;
	...
	public ControlRegistro(int tblcontrolDiarioId, int numeroResgitrosDiarios, Time tiempoNoLaborado,
			Time tiempoPermanencia, ControlDiario controlDiario) {
		super();
		this.tblcontrolDiarioId = tblcontrolDiarioId;
	...
	public String toString() {
		return "ControlRegistro [ numeroResgitrosDiarios=" + numeroResgitrosDiarios
