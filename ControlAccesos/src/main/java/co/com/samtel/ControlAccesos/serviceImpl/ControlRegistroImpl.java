...
public class ControlRegistroImpl implements IServiceControlRegistro {
	...
	@Override
	public void saveControlRegistro(int numRegistros, Time tiemNoLaborado, int idControlD, Time tiempoPer) {
		try {
			
			controlRegistro.guardarControlRegistro(numRegistros, tiemNoLaborado, idControlD, tiempoPer);
