...
public interface IServiceControlAccesoOrd extends IServiceRepo<ControlAccesosOrd,Integer> {
	...
	/**
	 * metodo que me permite traer todos los registros de la tabla tblcontrol_accesos_ord
	 * @param mes
	 * @param year
	 * @param diaI
	 * @param diaF
	 * @return devuelve una lista de todos los controlAccesosOrd
	 */
	
	public List<ReportControlAccesoOrd> findAllControlRegistrosOrd( int mes,  int year,  int diaI,  int diaF);
